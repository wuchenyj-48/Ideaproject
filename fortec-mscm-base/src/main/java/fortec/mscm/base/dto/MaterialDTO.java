...
public class MaterialDTO extends DataEntity  implements Serializable {
    ...
    @ExcelField(title = "品类代码", align = FieldAlign.CENTER, sort = 90)
    private String catalogCode;

    @ExcelField(title = "品类名称", align = FieldAlign.CENTER, sort = 100)
    private String catalogName;

    @ExcelField(title = "厂商名称", align = FieldAlign.CENTER, sort = 110)
