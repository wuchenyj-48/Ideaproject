package fortec.mscm.base.userdetails;
 ...
 */
@Slf4j
public class BaseUserDetailsServiceImpl extends UserDetailsServiceImpl {

    private UserClient userClient;

    private SupplierService supplierService;

    public BaseUserDetailsServiceImpl(UserClient userClient, SupplierService supplierService) {
        super(userClient);
